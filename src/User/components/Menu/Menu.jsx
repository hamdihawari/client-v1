...
export const Menu = () => {
    ...
    return (
        <>
            <div className={styleMobile.menuLayout}>
                <ul className={styleMobile.menu}>
                    <Link variant="text" className={styleMobile.menuBtn} styleMobile={{ color: changeColor ? "white" : "black" }}
                        onClick={() => { { toggleMenuHandel() } { changeColorHandel() } }}>Menu</Link>
                    <div className={styleMobile.controll}>
                        {
                            menuToggle && <Sidebar className={styleMobile.sidebar} />
                        }
                    </div>
